...
-- CreateEnum
CREATE TYPE "ExperienceLevel" AS ENUM ('APPRENTICE', 'ONE_TO_THREE', 'THREE_TO_FIVE', 'FIVE_TO_TEN', 'TEN_PLUS');

-- CreateEnum
CREATE TYPE "ReputationLevel" AS ENUM ('APPRENTICE', 'INSTALLER', 'EXPERIENCED', 'PRO', 'EXPERT', 'MASTER');

-- CreateEnum
CREATE TYPE "PostType" AS ENUM ('POST', 'BRAG', 'QUESTION', 'PROJECT', 'VIDEO');

-- CreateEnum
CREATE TYPE "ReportReason" AS ENUM ('SPAM', 'FAKE_ACCOUNT', 'OFFENSIVE', 'UNSAFE_ADVICE', 'ADVERTISING', 'OTHER');

-- CreateEnum
CREATE TYPE "ReportStatus" AS ENUM ('PENDING', 'REVIEWED', 'RESOLVED', 'DISMISSED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('LIKE', 'COMMENT', 'FOLLOW', 'MENTION', 'ANSWER', 'SOLUTION', 'BRAG_RANKING', 'PROJECT_COMMENT', 'MESSAGE');
...
CREATE TABLE "Profile" (
    ...
    "country" TEXT,
    "specialties" TEXT[],
    "experienceLevel" "ExperienceLevel" NOT NULL DEFAULT 'APPRENTICE',
    "reputationScore" INTEGER NOT NULL DEFAULT 0,
    "reputationLevel" "ReputationLevel" NOT NULL DEFAULT 'APPRENTICE',
    "verified" BOOLEAN NOT NULL DEFAULT false,
    "bragCount" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "Post" (
    ...
    "bragScore" INTEGER NOT NULL DEFAULT 0,
    "bragDetails" JSONB,
...
-- CreateTable
CREATE TABLE "BragPoint" (
    "id" TEXT NOT NULL,
    "postId" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "BragPoint_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Reputation" (
    ...
    "level" "ReputationLevel" NOT NULL DEFAULT 'APPRENTICE',
    "helpfulAnswers" INTEGER NOT NULL DEFAULT 0,
    "solvedQuestions" INTEGER NOT NULL DEFAULT 0,
    "bragEngagement" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "BragOfWeek" (
    ...
    CONSTRAINT "BragOfWeek_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "BragPoint_postId_userId_key" ON "BragPoint"("postId", "userId");
...
-- CreateIndex
CREATE UNIQUE INDEX "BragOfWeek_category_weekStart_key" ON "BragOfWeek"("category", "weekStart");
...
-- AddForeignKey
ALTER TABLE "BragPoint" ADD CONSTRAINT "BragPoint_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BragPoint" ADD CONSTRAINT "BragPoint_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
