...
export function ImmersiveSlideOverlay({ post, currentUserId, followingIds }: ImmersiveSlideOverlayProps) {
  ...
  return (
    <>
      ...
      {!commentsOpen && (
      <div className="absolute inset-x-0 bottom-0 z-10 flex w-full flex-col gap-2 px-3 py-3 pb-[var(--immersive-overlay-bottom-pad,1.25rem)] text-white pointer-events-auto sm:gap-3 sm:p-4">
